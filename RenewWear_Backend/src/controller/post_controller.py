...
def post_controller(app):
    ...
    @app.route('/create_postid',methods=['POST'])
    def create_postid():
    ...
    #사진 업로드 API 
    @app.route('/addimg/<int:post_id>',methods=['POST'])
    def upload_img(post_id):
        ...
        if result == "success" :
            ...
            return "해당 post_id 를 가진 사진 없음",400
        else :
    ...
    #사진 삭제 API
    @app.route('/deleteimg/<int:post_id>',methods=['DELETE'])
